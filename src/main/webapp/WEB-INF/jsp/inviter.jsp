...
<head>
    ...
    <title>With-Play 一个运动社交平台 </title>
...
<div class="panel panel-default" id="main" style="width: 70%;margin:1% 2% 5% 5%;float: left;">
    <%--<div class="panel-heading" style="background-color: white; height: 35px">--%>
            ...
            <div style="height: 50px; overflow: hidden">
                ...
                <div style="width: 90%;float: left;">
                    ...
                    <div>
                        ...
                        <a href="/member/${post.user.username}"><span ><strong>${post.user.username}</strong></span></a>&nbsp;&nbsp;&nbsp;
